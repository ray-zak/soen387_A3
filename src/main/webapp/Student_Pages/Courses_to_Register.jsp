<%@ page import="soen387.a2.CourseDAO" %>
...
<html>
<head>
    <title> Courses to Register </title>
...
<div class='py-3'>
        ...
        <div class='col-auto'>
            ...
            <table class='table table-bordered table-secondary table-sm '>
                ...
                <%
                    ...
                    List<course> courselst = (List<course>) request.getAttribute("courseList");
                ...
                <tr>
                    ...
                    <td> <button id="add<%=courselst.get(i).getCourseCode()%>" onclick="add_course('<%=courselst.get(i).getCourseCode() %>')"> Add Course </button></td>
                    <td> <button disabled id="remove<%=courselst.get(i).getCourseCode()%>" onclick="Remove_course('<%=courselst.get(i).getCourseCode() %>')"> Remove Course </button> </td>
                </tr>
                <%
                    }
                %>
    ...
    <div class='row justify-content-center my-5'>
        <div class='col-lg-6'>
            <form style='display: flex; flex-flow: column nowrap' id='courseList' method='post' action='/A2_war_exploded/Register'>
                ...
                <label class='form-label'> Number of courses added
                </label>
