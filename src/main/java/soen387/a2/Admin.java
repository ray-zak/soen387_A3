...
//    private int phone;
    ...
    public Admin( int AdminID, String FirstName, String LastName, String DOB, String Address ,String Email, int phone ){
        super(FirstName, LastName, DOB, Address, Email, phone);
